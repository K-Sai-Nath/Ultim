    ...
    <SafeAreaView className="flex-1 bg-background-light dark:bg-background-dark">
      ...
      {!HAS_ACCESS ? (
        <View className="flex-1 items-center justify-center px-6">
          ...
          <Text className="mt-4 text-lg font-bold text-text-primary-light dark:text-text-primary-dark text-center">
            No access to this activity
          </Text>

          <Text className="mt-2 text-sm text-text-secondary-light dark:text-text-secondary-dark text-center">
            This facility is not included in your current subscription.
          </Text>
          ...
          >
            <Text className="text-white font-bold">View Subscription</Text>
          </TouchableOpacity>
        </View>
      ) : (
        <>
